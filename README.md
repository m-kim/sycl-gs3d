...
The release `sycl-gs3d-cuda.zip` is a demo for Nvidia GPUs. It was tested on Windows 11 WSL2 with CUDA 12.6 and OneAPI 2023.2. It uses the same image set as the XPU version. 
